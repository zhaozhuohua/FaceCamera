...
/**
 * A [android.view.TextureView] that can be adjusted to a specified aspect ratio.
 */
open class AutoFitTextureView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : TextureView(context, attrs, defStyle) {
